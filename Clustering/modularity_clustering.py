...
if __name__ == "__main__":
    ...
    Graph_Lp = nx.modularity_matrix(Graph)
    #print(Graph_Lp)
    #exit()
    ...
    # print(i.shape)
    #U = np.array(Vec[:, i[1:5]])
    
    
    #Fit_plot_clusters(data,U,"clustering")
    eigen_matrix = np.zeros((Graph_Lp.shape[0],k))
    for i in range(0,k):
        
        eigen_matrix[:,i] = Vec[:,i].transpose()
    #print(eigen_matrix)
